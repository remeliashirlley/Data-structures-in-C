/* Write a recursive C function identical() to determine whether two binary trees are structurally identical, assuming the two binary trees as tree1 and tree2. 
...
(they are made of nodes with the same values and arranged in the same way). */
...

{
   /* add your code here */
    ...
    if(tree1 == NULL && tree2 == NULL)
        return 1;
    // One tree is empty but the other tree is not
    else if(tree1 == NULL || tree2 == NULL)
        return 0;
    // Both trees are not empty but don't have identical results
